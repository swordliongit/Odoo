...
---
### 7.Give Read/Write access to the Wizard
*Go to Security/ir.model.access.csv file and add the entry for the wizard at the bottom:

```csvtable
source: ir.model.access.csv
```
**Notes:**
Without giving this access, wizard won't be able to modify or read data and Odoo will give a warning pop when you press the button that calls the wizard action.